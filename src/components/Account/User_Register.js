            ...
            <div className="max-w-md w-full">
                ...
                <form onSubmit={handleSubmit} className="bg-white shadow-lg rounded px-8 pt-6 pb-8 my-20 bg-gray-200">
                    ...
                    <div className="flex items-center justify-between sm:flex-row">
                        ...
                        <A className="inline-block ml-2 text-center align-baseline font-bold text-sm text-indigo-600 hover:text-indigo-800" href="/login">
                            Already have an account?
                        </A>
                        <A className="inline-block align-baseline text-center font-bold text-sm text-indigo-600 hover:text-indigo-800" href="/register/facilityowner">
