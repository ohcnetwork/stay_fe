    ...
    return (
        <div className="h-full flex items-center justify-center py-5 px-4 sm:px-6 lg:px-8">
            <div className="max-w-md w-full">
                ...
                <form onSubmit={SubmitForm} className="bg-white shadow-lg rounded px-8 pt-6 pb-8 my-20 bg-gray-200">
                    <div className="mb-4">
                    ...
                    <div className="mb-4 md:flex md:justify-between">
                        ...
                        <div className="md:ml-2">
                            ...
                            <input
                                ...
                                value={form1.confirm}
                                onChange={OnInputChange}
                                className={`shadow appearance-none border ${error1.confirm ? "border-red-500" : ""} rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline`}
                                placeholder="******************" />
                            <div className="text-xs italic text-red-500">{error1.confirm}</div>
                        </div>
                    </div>
                    <div className="h-10">
                        <p className="text-red-500 text-xs italic bold text-center mt-2">{formError1}</p>
                    </div>
                    <div className="flex items-center justify-between sm:flex-row">
                        ...
                        <A className="inline-block ml-2 align-baseline text-center font-bold text-sm text-indigo-600 hover:text-indigo-800" href="/login">
                            Already have an account?
                        </A>
                        <A className="inline-block align-baseline text-center font-bold text-sm text-indigo-600 hover:text-indigo-800" href="/register/user">
