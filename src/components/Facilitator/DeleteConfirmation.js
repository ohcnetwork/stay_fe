            ...
            <div className="pb-8 px-0 md:w-1/2 bg-white shadow-lg mx-5 rounded">
                ...
                <div className="px-5">
                    <div className="pb-8 pt-3 px-0 text-gray-800">
                        You are about to delete the hotel{" "}
                        <span className="font-medium">{name}</span> with{" "}
                        <span className="font-medium">
                            {rooms} room{rooms === 1 ? "" : "s"}
                        </span>
                        . If you just want to change information, go to edit. If
                        you are sure then click delete.
                    </div>
                    {error && (
                    ...
                    <div className="flex justify-between font-bold tracking-wide">
                        ...
                        <div className="flex text-white">
                            <A
                                href={`/hotel/${id}/edit`}
                                className="flex items-center justify-center p-2 px-3 md:px-6 rounded mr-2 bg-indigo-600 hover:bg-indigo-800 cursor-pointer">
                                Edit
                            </A>
                            <div
                                onClick={del}
