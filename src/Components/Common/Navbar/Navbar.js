...
function Navbar() {
  ...
  return (
    <header className="navbar">
      ...
      <nav role="navigation" className={`${menuActive? "is-active": ""}`} onClick={menuDisable}>
        { 
          (user) 
        ?
          <>
            ...
            <div role="button" onClick={logoutUser} className="nav-link nav-btn nav-btn-theme">Logout</div>
          </>
        :
          <>
